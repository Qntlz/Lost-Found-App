...
export default function MyPost() {
    ...
    return (
        <div className="flex flex-col">
            {/* Header */}
            <div className="flex flex-row justify-between mx-7 p-4 pl-0">
                <div>
                    <span className="text-2xl font-medium text-red-500">My Posts</span>
                </div>
            </div>

            {/* Contents */}
            <div className="xl:w-[80%] lg:overflow-y-scroll no-scrollbar lg:h-[70vh]">
                {items.length > 0 ? (
                    items.map((item) => (
                                    ...
                                    <div>
                                        ...
                                        {item.status === "Missing" && (
                                            <button
                                                ...
                                                className="mt-1 bg-red-500 text-white px-3 py-1 rounded-md font-medium"
                                            >
                                                Mark as Found
                                            </button>
                                        )}
                    ...
                    <span className="mx-7">No Items Found</span>
                )}
            </div>
