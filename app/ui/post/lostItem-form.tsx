...
export default function LostItemForm({ formRef }: FormComponentProps) {
    ...
    return (
        <div>
            <form ref={formRef} onSubmit={handleFormSubmit} className="space-y-4 w-full">
                <Fieldset>

                    <div className="lg:flex w-full gap-10 lg:flex-col xl:flex-row">
                        ...
                        <div className="lg:flex flex-col w-full lg:order-2 gap-y-5">
                            ...
                            {selectedFile && <div className="flex w-full h-12 mb-3 items-center justify-between bg-red-100 rounded-3xl lg:mb-0">
                                <span className="ml-4 text-sm font-medium">{selectedFile.name}</span>
                        ...
                        {/* Information Field */}
                        <div className="space-y-3 lg:order-2 xl:order-1">

                            {/* Item Field */}
                            <Legend className="text-xl text-red-500">Item details</Legend>
                            <Field>
                            ...
                            <Field>
                                        ...
                                        <div className="flex flex-wrap gap-2 mt-2">
                                            {[
                                                ...
                                                <button
                                                    key={color}
                                                    type="button"
                                                    className={`px-3 py-1.5 rounded-full bg-gray-200 text-black hover:bg-gray-300 ${selectedTags.includes(color)
                                                        ? "border border-red-500 bg-transparent hover:bg-transparent"
                                                        : "border-none"
                                                        }`}
                                ...
                                <div className="mt-3">
                                    ...
                                    ${showCommonItems ? "max-h-96 opacity-100" : "max-h-0 opacity-0"}`}>
                                        <div className="flex flex-wrap gap-2 mt-2">
                                            {[
                                                "Smartphone", "Tablet", "Smartwatch", "Wallet",
                                                "Earbuds", "Laptop", "Bag",
                                            ].map((item) => (
                                                <button
                                                    key={item}
                                                    type="button"
                                                    className={`px-3 py-1.5 rounded-full bg-gray-200 text-black hover:bg-gray-300 ${selectedTags.includes(item)
                                                        ? "border border-red-500 bg-transparent hover:bg-transparent"
                                                        : "border-none"
                                                        }`}
